...
use App\Http\Controllers\Archives\ArchiveOutgoingFileController;
use App\Http\Controllers\Archives\ArchiveDocumentController;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::resources([
        ...
        'archive_outgoing_files' => ArchiveOutgoingFileController::class,
    ]);
