...
class UserRoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('user_role')->insert([
            ...
            [
                'id' => 'cabb4d3b-38d7-4ed0-904d-cd2797aab73g',
