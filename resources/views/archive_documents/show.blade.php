            ...
            <div class="col pt-3">
                ...
                <div class="d-flex justify-content-center my-4">
                    ...
                    @can('update', \App\Models\Documents\Document::class)
                        <div class="mx-3">
                            <a style="width:170px" class="btn btn-sm btn-danger" href="{{route('documents.edit', $archive_document)}}">Редактировать</a>
                        </div>
                    @endcan
                    <div class="mx-3">
                        <a style="width:170px" class="btn btn-sm btn-warning {{isset($archive_document->tasks[0]) ? 'disabled' : ''}}" href="{{route('documents.create_task', $archive_document)}}">Добавить резолюцию</a>
                    </div>
                </div>
            </div>
        </div>
