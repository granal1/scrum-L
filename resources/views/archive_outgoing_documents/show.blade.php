...
{{--                </div>--}}
                ...
                <div class="d-flex justify-content-center my-4">
                    <div class="mx-3">
                        <a class="btn btn-sm btn-primary" style="width:150px" href="{{route('archive_outgoing_documents.index', ['year' => Session::get('year'), 'page' => Session::get('page')])}}">Назад
                        </a>
                    </div>
                    @can('update', \App\Models\OutgoingFiles\OutgoingFile::class)
                        <div class="mx-3">
                            <a class="btn btn-sm btn-primary" style="width:150px" href="{{route('archive_outgoing_documents.edit', $archive_document->id)}}">Редактировать</a>
                        </div>
                    @endcan
                </div>
