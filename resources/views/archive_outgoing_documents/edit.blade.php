...
@section('title', 'Редактирование исходящего документа')
    ...
    <div class="container mb-3 mt-3 card shadow-lg">
        <div class="row">
            ...
            <div class="col pt-3">
                @include('message')
                <form action="{{route('archive_outgoing_documents.update', $archive_document['id'])}}" method="post">
                    @csrf
                    @method('patch')
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-8">
                            <input type="date" id="outgoing_at" name="outgoing_at" class="form-control form-select-sm" placeholder="Дата исходящего документа" value="{{date('Y-m-d', strtotime($archive_document['outgoing_at']))}}">
                            @error('outgoing_at')
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-8">
                            <input type="text" class="form-control form-control-sm" id="outgoing_number" placeholder="Номер исходящего документа" name="outgoing_number" value="{{$archive_document['outgoing_number']}}">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-8">
                            <input type="text" class="form-control form-control-sm" id="destination" placeholder="Укажите получателя документа" name="destination" value="{{$archive_document['destination']}}">
                            @error('destination')
                            <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-8">
                            <input type="text" class="form-control form-control-sm" id="number_of_source_document" placeholder="Укажите номер документа, на который отвечаете" name="number_of_source_document" value="{{$archive_document['number_of_source_document']}}">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-8">
                            <input type="date" id="date_of_source_document" name="date_of_source_document" class="form-control form-select-sm" placeholder="Укажите дату документа, на который отвечаете" value="{{date('Y-m-d', strtotime($archive_document['date_of_source_document']))}}">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-8">
                            <input placeholder="Укажите тип и наименование документа" class="form-control form-control-sm" name="short_description" id="short_description" value="{{$archive_document['short_description']}}">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-8">
                            @if(!empty($archive_document->archive_path))
                                <input disabled readonly class="form-control form-control-sm" name="archive_path" id="archive_path" value="{{$archive_document['archive_path']}}">
                            @else
...
{{--                        </div>--}}
{{--                        <div class="col-8">--}}
{{--                            <input  type="text" required readonly list="executors_list" class="form-control form-control-sm" id="executor_name" name="executor_name" value="{{$archive_document->executor->name}}">--}}
{{--                            @error('executor_name')--}}
{{--                            <div class="text-danger">{{$message}}</div>--}}
{{--                            @enderror--}}
{{--                        </div>--}}
{{--                    </div>--}}
                    ...
                    <div class="d-flex justify-content-center my-4">
                        <div class="mx-3">
                            <a type="button" style="width:150px" class="btn btn-success btn-sm"  href="{{route('archive_outgoing_documents.show', $archive_document['id'])}}">Назад</a>
                        </div>
                        <div class="mx-3">
                            <button type="submit" style="width:150px" class="btn btn-warning btn-sm">Сохранить</button>
                        </div>
                </form>
                        <form action="{{route('archive_outgoing_documents.destroy', $archive_document['id'])}}" method="post">
                            @csrf
                            @method('delete')
                            <div class="mx-3">
