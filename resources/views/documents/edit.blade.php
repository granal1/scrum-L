        ...
        <form action="{{route('documents.update', $document)}}" method="post">
            ...
            <div class="row row-cols-1">
                <div class="col mt-3">
                    ...
                    <textarea disabled readonly placeholder="Описание задачи" class="form-control form-control-sm" name="executed_result" id="executed_result" rows="2">{{isset($document->tasks[0]) ? $document->tasks[0]->currentHistory->comment : null}}</textarea>
