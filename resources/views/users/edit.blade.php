...
<div class="container mb-3 mt-3 card shadow-lg">
    <div class="row">
        <div class="col-lg-2 col-md-12 rounded text-white bg-primary pt-3" style="--bs-bg-opacity: .4">
            <div class="row">
                <div class="col">
                    <h4 class="d-inline-block">Редактирование карточки сотрудника</h4>
                </div>
            </div>
        </div>
        ...
        <div class="col pt-3">
            ...
            <form action="{{route('users.update', $user)}}" method="post">
                ...
                <div class="row mt-3">
                    <div class="col-4 text-end">
                        <label for="role_uuid" class="form-label form-label-sm">Роли<br>(возможен выбор нескольких пунктов)</label>
                    </div>
                    <div class="col-8">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-8">
                        <input type="date" id="employment_at" name="employment_at" class="form-control form-control-sm" value="{{\Carbon\Carbon::parse($user->employment_at)->format('Y-m-d')}}">
                        @error('employment_at')
                        <div class="text-danger">{{$message}}</div>
                        @enderror
                    </div>
