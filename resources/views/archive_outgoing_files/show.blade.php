        ...
        <div class="row">
            ...
            <div class="col pt-3">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-8">
                        <input readonly disabled type="text" class="form-control form-control-sm" id="executor_uuid"
                            ...
                            value="{{$output_file->executor_uuid}}"> 
                        @error('executor_uuid')
                        <div class="text-danger">{{$message}}</div>
                        @enderror
                    </div>
                ...
                <div class="d-flex justify-content-center my-4">
                    <div class="mx-3">
                        <a style="width:150px" class="btn btn-sm btn-success"  href="{{route('archive_outgoing_files.index')}}">Назад
                        </a>
                    </div>
                    {{-- @can('update', \App\Models\ArchivesOutgoingFiles\ArchiveOutgoingFile::class)
                        <div class="mx-3">
